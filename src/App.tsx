...
// Import media files directly
import gambarLive from './gambar-live.png';
import performanceAnalytics from './performance-analytics.png';
import videoKarya1 from './video-karya-1.mp4';
import videoKarya2 from './video-karya-2.mp4';
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                videoUrls: [videoKarya1, videoKarya2],
              },
              {
                ...
                contentImage: performanceAnalytics,
